    ...
    <section id="about" className="bg-white section-padding">
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            <h2 className="font-display text-[clamp(32px,4.5vw,56px)] font-normal leading-[1.08] tracking-[-0.02em] text-foreground max-w-[550px]">
          ...
          <div className="space-y-6">
            <motion.p
              ...
              className="font-body text-[17px] leading-[1.7] text-foreground/55"
            >
            ...
            <motion.p
              ...
              className="font-sans text-[18px] font-semibold leading-[1.5] text-foreground"
            >
